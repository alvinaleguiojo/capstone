...
export default function GridTableDiagnosis({
  rows,
  columns,
  path,
  maxHeight,
  ...
  const diagnosisID = JSON.stringify(id);
          ...
          if (value) {
            ...
            axios
              ...
              .then(() => {
                ...
                const updatedAppointment = rowsData.map((updateAppoinment) => {
                        ...
                        <TableCell
                          ...
                          onClick={() => {
                            showModal
                              ? handleDiagnosis(row)
                              : router.push(
                                  `/patients/${diagnosisID}/${path}/${row.DiagnosisID}`
                                );
                          }}
                          disabled={true}
                        >
